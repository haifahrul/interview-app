...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['username'], 'required'],
            [['username', 'email', 'password_hash', 'password_default'], 'string', 'max' => 255],
    ...
    public function scenarios()
    {
        ...
        $scenarios['update-profile'] = ['username', 'email'];
        $scenarios['password'] = ['old_password', 'new_password', 'repeat_password'];
        $scenarios['createInterviewer'] = ['username', 'password_hash', 'password_default', 'email'];
        return $scenarios;
    }
    ...
    {
        return $this->hasOne(UserInterviewer::className(), ['user_id' => 'id']);
    }
}
