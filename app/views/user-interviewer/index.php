...
/* @var $searchModel app\models\search\UserInterviewerSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */
$this->title = Yii::t('app', 'User Interviewer');
$this->params['breadcrumbs'][] = $this->title;
$this->params['title'] = 'List'.$this->title;
?>
<div class="box">
<div class="box-body">
    <div class="user-interviewer-index">
...
<?=  \app\widgets\PageSize::widget([
        ...
        <?= Html::a('<i class="glyphicon glyphicon-plus glyphicon-sm"></i> Create ' , ['create'], ['data-pjax'=>0,'class' => 'btn btn-primary btn-sm btn-tambah1']) ?> &nbsp &nbsp
    ...
    'filterModel' => $searchModel,
        'columns' => [
            ...
            [
                ...
                // 'enum' => Jabatan::getListData(),
                // 'filter' => Jabatan::getListData(),
                'value' => function ($data) {
            ...
            [
                'attribute' => 'fakultas_unit_id',
                'format' => 'raw',
                // 'class' => EnumColumn::className(),
                // 'enum' => FakultasUnit::getListData(),
                // 'filter' => FakultasUnit::getListData(),
                'value' => function ($data) {
                    return $data['fakultasUnit']['nama'];
                }
            ],
            [
                'attribute' => 'is_active',
