...
use app\models\AspekPenilaianTipe;
    use app\models\search\AspekPenilaianTipeSearch;
...
class AspekPenilaianTipeController extends Controller
 {
...
{
    $searchModel = new AspekPenilaianTipeSearch();
...
$model = AspekPenilaianTipe::findOne($key);
if($model->delete())
$status=1;
else
$status=2;
...
//$model = AspekPenilaianTipe::findOne($keys);
//$model->delete();
//$status=3;
}
// retrun nya json
...
{
if (($model = AspekPenilaianTipe::findOne($id)) !== null) {
return $model;
} else {
