...
/* @var $searchModel app\models\search\AspekPenilaianSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */
$this->title = Yii::t('app', 'Aspek Penilaian');
...
<div class="box">
    <div class="box-body">
        <div class="aspek-penilaian-index">
            ...
            <?= Html::a('<i class="glyphicon glyphicon-plus glyphicon-sm"></i> Create ', ['create'], ['data-pjax' => 0, 'class' => 'btn btn-sm btn-primary btn-tambah1'])
            ?> &nbsp &nbsp
            ...
            <div class="table-responsive">
                ...
                GridView::widget([
                    ...
                    'columns' => [
                        ...
                        'nama',
                        [
                            'attribute' => 'aspek_penilaian_tipe_id',
                            'value' => function ($data) {
                                return $data['aspekPenilaianTipe']['nama'];
                            }
                        ],
                        [
                            'attribute' => 'is_active',
