...
namespace app\widgets\admin\components;
 ...
 * 
 * ```
 * Yii::$container->set('app\widgets\admin\components\Configs',[
 *     'db' => 'customDb',
 *     'menuTable' => 'admin_menu',
 * ]);
 * ```
...
class Configs extends \yii\base\Object
{
    ...
    public static function instance()
    {
        if (self::$_instance === null) {
            $type = ArrayHelper::getValue(Yii::$app->params, 'app.admin.configs', []);
